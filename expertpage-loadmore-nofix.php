                       ...
                       // print_r ( $request);
                        ...
                        if( is_wp_error( $request ) ) {
                            ...
                            if (!empty($data_expert)){
                                ...
                                //print_r($data_expert->paging);
                                 //$result_per_page = 4;
                            //$number_of_result = 952;
                           ...
                           // print_r($number_of_pages);
									...
									<div class="col-lg-3 col-sm-6">
										<div class="card hovercard">
											...
											<div class="info">
												...
												<div class="desc"><?php load_more_button(); ?></div>
											</div>
											<!-- <div class="bottom">
                            ...
                            <?php                                 
							 ...
							 //manual foreach into page
							$result_per_page = $data_expert->paging->record_per_page;
                            $number_of_result = $data_expert->paging->total_record;
                            $number_of_pages = ceil($number_of_result/$result_per_page);
                            print_r($number_of_pages);
                            //print_r($number_of_pages);
